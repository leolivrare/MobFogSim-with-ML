...
public class NextStep {
	...
	private static void saveMobility(MobileDevice st) {
			...
			PrintWriter out1 = new PrintWriter(bw1))
		{
			...
			out1.println("Local server: " + st.getVmLocalServerCloudlet().getName() + " Latency "
				+ st.getVmLocalServerCloudlet().getUplinkLatency() + " Map "
			...
			if (st.getSourceServerCloudlet() == null) {
				...
				out1.println("Source server: " + st.getSourceServerCloudlet().getName() + " Latency: "
					+ st.getSourceServerCloudlet().getUplinkLatency() + " Map "
